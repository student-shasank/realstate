         ...
         <div className="flex flex-col items-center bg-white">
              ...
              <div className="w-full max-w-[1200px] px-4  py-20 ">
                ...
                >
                  ...
                  <p>This ensures that projects move forward with the right positioning, the right execution pathway, and a clear structure from day one.
                  </p>
                </div>
              </div>
              ...
              <section className="relative flex w-full items-center justify-center overflow-hidden pb-10">
                <div className="relative flex h-[568px] w-[1200px] items-center justify-between px-4">
                  ...
                  <div className="z-20 flex flex-col gap-10">
                    ...
                    <h1 className="font-['General_Sans']   h-[165.66px] w-[1200.66px] text-[64px] font-medium leading-[1.2] tracking-normal text-[#01155E]  ">
