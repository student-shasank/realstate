...
function Propertysale() {
  return (
    <div className="flex flex-col items-center bg-white w-full">
      ...
      {/* TOP TEXT SECTION */}
      <div className="w-full max-w-[1200px] px-4 sm:px-4  py-12 sm:py-16 lg:py-20">

        {/* HEADING */}
        <div className="mb-8 sm:mb-10">
          <h2
            className="text-[#01155E] text-[22px] sm:text-[26px] lg:text-[32px] font-semibold mb-[10px]"
            style={{ fontFamily: 'Archivo, sans-serif' }}
          >
            Next Step – Discuss Your Project
          </h2>
          <div className="flex w-full max-w-[300px] sm:max-w-[360px] lg:max-w-[414px] items-end">
            <div className="w-[120px] sm:w-[140px] lg:w-[162px] h-[6px] sm:h-[8px] bg-[#01155E]" />
        ...
        <div
          className="flex flex-col gap-[8px] text-[#01155E] text-[14px] sm:text-[16px] lg:text-[18px] font-normal  border-l-[3px] border-[#01155E] pl-4 sm:pl-6"
      ...
      {/* HERO / CTA SECTION */}
      <section className="relative flex w-full items-center justify-center overflow-hidden pb-8 sm:pb-10">
        <div className="relative w-full max-w-[1200px] min-h-[300px] sm:min-h-[400px] lg:min-h-[480px] flex items-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-20 flex flex-col gap-6 sm:gap-8 py-10 sm:py-14 lg:py-20">
            <h1
              ...
              style={{ fontFamily: 'General Sans, sans-serif' }}
            >
              Looking to <br /> Property Management Structuring?
            </h1>
            <button
